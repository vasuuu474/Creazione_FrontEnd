...
import { Bell, ChevronDown, Check, LogOut, User, Settings, Users } from 'lucide-react'
...
export default function Navbar({ onSettingsClick, currentUser, onUserSwitch, isFounder }) {
