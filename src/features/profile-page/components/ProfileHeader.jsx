    ...
    <header className="sticky top-0 z-40 w-full bg-white/90 dark:bg-zinc-900/90 backdrop-blur-md border-b border-border dark:border-zinc-800 shadow-sm">
      <div className="max-w-[1280px] mx-auto px-4 md:px-12 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8 md:gap-12">
          {/* Logo */}
          <a href="#" className="font-serif text-2xl font-semibold text-primary dark:text-[#b4cdb8] hover:opacity-90 transition-opacity">
            Creazione
          </a>
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          {/* Avatar Profile */}
          <button className="relative flex items-center gap-1 hover:opacity-90 transition-opacity cursor-pointer" aria-label="User profile">
